...
2.  Is there an apparent trend in the number of girls baptized over the years?  
    ...
    Yes there is an apparent trend in the number of girls baptized each year. Inititally the numbers declined a bit then increased and then there was a steep decline starting 1640 which lasted until 1660 then the numbers started to climb up again until 1700s.
...
-   How do these counts compare to Arbuthnot's? Are they on a similar scale?
    ...
    Answer: As compared to the Arbuthnot's counts these counts are significantly higher as they are in the millions per year however, in arbuthnot's data set they were in thousands.
    
    ```{r Comparison-Arbuthnot-Present, eval=TRUE}
   mean_arbuthnot<- mean(arbuthnot$girls+arbuthnot$boys)
   mean_present<- mean(present$girls+present$boys)
   
   mean_present/mean_arbuthnot
...
-   Make a plot that displays the boy-to-girl ratio for every year in the data 
    ...
    Answer: Below is the ratio between boy-to-girl
