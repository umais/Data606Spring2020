...
iii) The highest difference between one of the simulations is 44% which leads us to the following conclusion
...
### Alternative Model
    ...
    Thst the transplant was actually effective in keeping people alive that is the reason for such a big difference.
